    ...
    fn = (function(_this) {
      return function(i, opts) {
        ...
        return _this._runner()(name, function() {
          var after_hook, before_hook, mod, phantomInstance, phantomPage, ref2, server, test, tests;
          ...
          before_hook(function() {
            var port, ref3, ref4, ref5, router;
            this.retries((ref3 = mod._hook_retries) != null ? ref3 : 1);
            this.timeout((ref4 = mod._hook_timeout) != null ? ref4 : 8000);
            ref5 = [], router = ref5[0], port = ref5[1];
            return getPort().then((function(_this) {
              return function(p) {
                var next;
                port = p;
          ...
          return after_hook(function() {
            var ref3, ref4;
            this.retries((ref3 = mod._hook_retries) != null ? ref3 : 1);
            this.timeout((ref4 = mod._hook_timeout) != null ? ref4 : 6000);
            if (phantomPage) {
              phantomPage.close();
            }
            if (phantomInstance) {
