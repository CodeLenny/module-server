    ...
    fn = (function(_this) {
      return function(i, count) {
        ...
        return describe(name, function() {
          var _it, _phantomStarted, _started, k, len, moduleServer, onItStart, onStart, path, phantomInstance, phantomPage, ref2, ref3, ref4, results, ret, router, server;
  ...
  ModuleTest.prototype.chrome = function(timeout) {
    ...
    getPort((function(_this) {
      return function(port) {
        var closed, moduleServer, name, path, ref1, router, server;
        router = express();
        router.get("/", _this._index);
        closed = null;
        if (timeout === 0) {
          closed = new Promise(function(resolve, reject) {
            ...
            router.get("/test.js", open, _this._listenCloseTestScript);
