...
TestRun = (function() {
  ...
  TestRun.prototype.it = function() {
    var done, post, ref, started, test;
    ref = this, test = ref.test, started = ref.started, post = ref.post, done = ref.done;
    return it(test.name, function() {
      ...
      return post.then(function(data) {
        ...
        return function() {
          if (_this.state === "failed" && _this.currentRetry() < _this.retries()) {
            return;
          }
          return done.resolve();
        };
